...
function OverviewView() {
  ...
  return <div className="grid h-full min-h-[640px] grid-cols-12 grid-rows-[1fr_1fr_auto] gap-2">
...
export default function Dashboard() {
  ...
  return <div className="dashboard-shell flex h-screen min-h-[540px] flex-col overflow-hidden bg-noatum-mist">
    ...
    <main className={`dashboard-main relative grid min-h-0 flex-1 ${active === "Report" ? "grid-rows-[minmax(0,1fr)] bg-white p-0" : "z-10 -mt-[31px] grid-rows-[104px_minmax(0,1fr)] gap-2 px-2 pb-2"}`}>
